            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <a href="javascript:void(0)" class="btn btn-primary btn-flat m-b-30 m-t-30"
                                    data-toggle="modal" data-target="#addBanner">Add New</a>
                            </div>
                            <div class="col-md-6">
                                @if (session('success'))
                        ...
                        <!-- Banner Add Modal -->
                        <div class="modal fade" id="addBanner" tabindex="-1" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="#" class="row" method="post" enctype="multipart/form-data">
                        <div class="form-group col-12">
                            <img src="{{ asset('public/upload/images/no-image.jpg') }}" class="border rounded"
                                width="120" alt="">
                        </div>
                        <div class="form-group col-12">
