        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form name="menu_form_category" action="{{ url('assignorder') }}" method="post" id="formsubmit"
                            enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label>{{ __('messages.order_id') }}</label>
                                <input type="text" class="form-control" placeholder="{{ __('messages.order_id') }}"
                                    name="id" id="order_id" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-primary btn-md form-control" id="assign_order_to_boy">{{ __('messages.add') }}</button>
                                </div>
                                <div class="col-md-6">
...
@push('js')
    <script>
        ...
        const submitButton = document.getElementById("assign_order_to_boy");
