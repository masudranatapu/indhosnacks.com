        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{url('deliveryboy/dashboard')}}"> <i
                                class="menu-icon fa fa-dashboard"></i>{{__('messages.dashboard')}}</a>
                    </li>
                    <li class="active">
                        <a href="{{url('deliveryboy/orderhistory')}}"> <i
                                class="menu-icon fa fa-list-alt"></i>{{__('messages.order_history')}}</a>
                    </li>
                    <li class="active">
                        <a href="{{url('deliveryboy/editprofile')}}"> <i
                                class="menu-icon fa fa-dashboard"></i>{{__('messages.my_pro')}}</a>
                    </li>
                    <li class="active">
                        <a href="{{url('deliveryboy/changepassword')}}"> <i
                                class="menu-icon fa fa-list-alt"></i>{{__('messages.change_password')}}</a>
                    </li>
                    <li class="active">
                        <a href="{{url('deliveryboy/logout')}}"> <i
                                class="menu-icon fa fa-dashboard"></i>{{__('messages.logout')}} </a>
                    </li>
                </ul>
            </div>
        </nav>
                ...
                <div class="col-sm-1">
                    <div class="user-area dropdown float-right">
                        ...
                        if (@GetImageSize($external_link)) {
                            ...
                            <img class="user-avatar rounded-circle" src="{{$image}}"
                                alt="{{__('messages.user_avtar')}}">
                        </a>
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="{{url('deliveryboy/editprofile')}}"><i
                                    class="fa fa-user"></i>{{__('messages.my_pro')}}</a>
                            <a class="nav-link" href="{{url('deliveryboy/changepassword')}}"><i class="fa fa-user"></i>
                                {{__('messages.change_password')}}</a>
                            <a class="nav-link" href="{{url('deliveryboy/logout')}}"><i class="fa fa-power-off"></i>
