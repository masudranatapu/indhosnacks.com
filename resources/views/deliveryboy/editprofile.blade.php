                ...
                <div class="card-body">
                    <div id="pay-invoice">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{url('deliveryboy/updateprofile')}}" method="post" novalidate="novalidate"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly id="email" name="email"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="vehicle_no" name="vehicle_no"
                                        placeholder="{{__('messages.vehicle_no')}}" required class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="vehicle_type" name="vehicle_type"
                                        placeholder="{{__('messages.vehicle_type')}}" class="form-control" required=""
