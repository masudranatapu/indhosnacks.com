...
function accept_record(url, id) {

    const buttonorderaccepting = document.getElementById("acceptrecord__" + id);

    $("#acceptrecord__" + id).html(
        '<span style="color: white;">Processing...</span>'
    );

    buttonorderaccepting.disabled = true;
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            buttonorderaccepting.disabled = false;
...
function reject_record(url, id) {

    const buttonorderaccepting = document.getElementById("rejectrecord__" + id);

    $("#rejectrecord__" + id).html(
        '<span style="color: white;">Processing...</span>'
    );
